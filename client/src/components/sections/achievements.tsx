...
export default function Achievements() {
  const achievements = [
    ...
    {
      id: "kiit-fest-hackathon",
      num: "03",
      title: "KIIT Fest Hackathon Winner",
      label: "Hackathon · KIIT Fest",
      period: "Feb 2026",
      icon: "fas fa-award",
      bullets: [
        "Built EduChain, a blockchain-based learning and credential platform for students and educators",
        "Turned the idea into a working demo with clear product flow, UI, and on-chain-focused architecture",
        "Presented the project under hackathon pressure and won the KIIT Fest hackathon",
      ],
      link: "https://github.com/Aditya-alchemist/EduChain",
    ...
    },
    {
      ...
      label: "Academic · Peer-reviewed Journals · Patented",
      period: "2025 – Present",
      icon: "fas fa-flask",
      bullets: [
        ...
        "Now patented, adding formal recognition to the research work",
      ],
