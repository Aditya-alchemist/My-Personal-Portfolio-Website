...
export default function FloatingCrypto() {
  const cryptoIcons = [
    ...
    { icon: "fas fa-yen-sign", color: "#2a5ada", size: "text-3xl", position: "bottom-20 right-40", name: "Marker" },
    { icon: "fas fa-cube", color: "#8247e5", size: "text-3xl", position: "top-80 right-1/3", name: "Polygon" },
    { icon: "fas fa-euro-sign", color: "#0052ff", size: "text-2xl", position: "top-60 left-1/2", name: "Base" },
    { icon: "fab fa-bitcoin", color: "#f7931a", size: "text-4xl", position: "top-20 left-20", name: "Bitcoin" },
    { icon: "fas fa-dollar-sign", color: "#26a17b", size: "text-2xl", position: "bottom-80 right-1/2", name: "USD" },
    { icon: "fas fa-dollar-sign", color: "#7d00ff", size: "text-2xl", position: "top-1/2 left-10", name: "Stellar" },
    { icon: "fab fa-bitcoin", color: "#627eea", size: "text-3xl", position: "top-40 right-20", name: "Ethereum" },
  ];
